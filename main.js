...
var hu = {
  ABOUT: "R\xF3lunk",
  CREATED_WITH_LOVE: "K\xE9sz\xFClt \u2764\uFE0F -el:",
  DOCUMENTATION: "Dokument\xE1ci\xF3",
  CHANGELOG: "V\xE1ltoz\xE1sok",
  LANGUAGE: "Nyelv",
  SYSTEM: "Rendszer",
  PROCESSING: "Feldolgoz\xE1s",
  BIBLE_EDITION: "Haszn\xE1lja a Magyar\xE1zatos Bibli\xE1t",
  BIBLE_EDITION_DESC: "Haszn\xE1lja a Magyar\xE1zatos Bibli\xE1t a hivatkoz\xE1sok megnyit\xE1s\xE1hoz, ha el\xE9rhet\u0151 az \xD6n nyelv\xE9n.",
  EXPAND_BIBLE_BOOK_NAME: "A Bibliai k\xF6nyv nev\xE9nek kibont\xE1sa",
  EXPAND_BIBLE_BOOK_NAME_EXAMPLE: "Pl. '1M\xF3' => '1M\xF3zes'.",
  AUTO_GET_CURRENT_LINE: "Aktu\xE1lis sor automatikus beolvas\xE1sa",
  AUTO_GET_CURRENT_LINE_DESC: "Automatikusan beolvassa a Bibliai sz\xF6veget abb\xF3l a sorb\xF3l ahol a kurzor van, ha nincs kijel\xF6lve semmi.",
  STYLING: " St\xEDlus",
  CAPITALIZE_FIRST_CHARACTER: "A bibliai k\xF6nyv linkje nagybet\u0171vel",
  CAPITALIZE_FIRST_CHARACTER_DESC: "Nagybet\u0171vel fog kezd\u0151dni a linkelt bibliai k\xF6nyv neve.",
  ADD_SPACE_BIBLE_BOOK_NUMBER_NAME: "Sz\xF3k\xF6z hozz\xE1ad\xE1sa a Bibliai k\xF6nyv sz\xE1ma \xE9s a Biblia k\xF6nyv neve k\xF6z\xE9",
  ADD_SPACE_BIBLE_BOOK_NUMBER_NAME_DESC: "Sz\xF3k\xF6zt ad hozz\xE1 a sz\xE1m \xE9s a k\xF6nyv k\xF6z\xE9, pl. '1 J\xE1nos'.",
  RENDER_LINK_OUTPUT_BOLD: "A link kimenet\xE9nek f\xE9lk\xF6v\xE9rr\xE9 t\xE9tele",
  RENDER_LINK_OUTPUT_BOLD_DESC: "F\xE9lk\xF6v\xE9r bet\u0171vel jelen\xEDti meg a kimeneti linket.",
  RENDER_LINK_OUTPUT_ITALIC: "A link kimenet\xE9nek d\u0151lt bet\u0171vel val\xF3 megjelen\xEDt\xE9se",
  RENDER_LINK_OUTPUT_ITALIC_DESC: "D\u0151lt bet\u0171vel jelen\xEDti meg a kimeneti linket.",
  LINK_PREFIX: "Link el\u0151tag",
  LINK_PREFIX_DESC: "El\u0151tag a linkhez, pl. '- '.",
  LINK_SUFFIX: "Link ut\xF3tag",
  LINK_SUFFIX_DESC: "Ut\xF3tag a linkhez, pl. '!!!'.",
  PREFIX_HERE: "El\u0151tag ide",
  SUFFIX_HERE: "Ut\xF3tag ide",
  CLEAR_LINK_PREFIX: "Link el\u0151tag t\xF6rl\xE9se",
  CLEAR_LINK_SUFFIX: "Link ut\xF3tag t\xF6rl\xE9se",
  INVALID_INPUT: "\xC9rv\xE9nytelen bibliai sz\xF6vegbevitel! A parancs v\xE9grehajt\xE1sa el\u0151tt ki kell v\xE1lasztania egy \xE9rv\xE9nyes bibliai sz\xF6veget, p\xE9ld\xE1ul: '1 ti 1:3-8'.",
  AUTO_OPEN_LINK: "Automatikusan megnyitja a gener\xE1lt linket",
  AUTO_OPEN_LINK_DESC: "Automatikusan megnyitja a gener\xE1lt linkeket a JW Library alkalmaz\xE1sban."
};
...
var MainSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName(this.getTranslation("LANGUAGE")).setDesc("").addDropdown(
      (String) => String.addOption("/", this.getTranslation("SYSTEM")).addOption("en", "English").addOption("fr", "Fran\xE7ais").addOption("nl", "Nederlands").addOption("de", "Deutsch").addOption("pt-br", "Portugu\xEAs (Brasil)").addOption("es", "Espa\xF1ol").addOption("fi", "Finnish").addOption("ua", "\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430").addOption("hu", "Magyar").setValue(
  ...
  async onload() {
    ...
    const convertBibleTextToJWLibraryLink = (editor) => {
      ...
      try {
        ...
        const wtLocaleHU = "H";
        const bibleBooksHU = [
          ["1m\xF3", "1mo", "1m\xF3zes"],
          ["2m\xF3", "2mo", "2m\xF3zes"],
          ["3m\xF3", "3mo", "3m\xF3zes"],
          ["4m\xF3", "4mo", "4m\xF3zes"],
          ["5m\xF3", "5mo", "5m\xF3zes"],
          ["jzs", "jozs", "j\xF3zsu\xE9"],
          ["b\xED", "bir", "b\xEDr\xE1k"],
          ["ru", "ruth", "ruth"],
          ["1s\xE1", "1sam", "1s\xE1muel"],
          ["2s\xE1", "2sam", "2s\xE1muel"],
          ["1ki", "1kir", "1kir\xE1lyok"],
          ["2ki", "2kir", "2kir\xE1lyok"],
          ["1kr", "1kron", "1kr\xF3nik\xE1k"],
          ["2kr", "2kron", "2kr\xF3nik\xE1k"],
          ["ezs", "ezsdr", "ezsdr\xE1s"],
          ["ne", "neh", "neh\xE9mi\xE1s"],
          ["esz", "eszt", "eszter"],
          ["j\xF3b", "job", "j\xF3b"],
          ["zs", "zsolt", "zsolt\xE1rok"],
          ["pl", "peld", "p\xE9ldabesz\xE9dek"],
          ["pr", "pred", "pr\xE9dik\xE1tor"],
          ["\xE9n", "enek", "\xE9nekek \xE9neke"],
          ["\xE9zs", "ezsai", "\xE9zsai\xE1s"],
          ["jr", "jer", "jeremi\xE1s"],
          ["si", "siral", "siralmak"],
          ["ez", "ezek", "ez\xE9kiel"],
          ["d\xE1", "dan", "d\xE1niel"],
          ["h\xF3", "hos", "h\xF3se\xE1s"],
          ["j\xF3e", "joel", "j\xF3el"],
          ["\xE1m", "amo", "\xE1m\xF3s"],
          ["ab", "abd", "abdi\xE1s"],
          ["j\xF3n", "j\xF3n\xE1s", "j\xF3n\xE1s"],
          ["mi", "mike", "mike\xE1s"],
          ["n\xE1", "nah", "n\xE1hum"],
          ["ha", "hab", "habakuk"],
          ["so", "sof", "sof\xF3ni\xE1s"],
          ["ag", "agg", "aggeus"],
          ["za", "zak", "zakari\xE1s"],
          ["ma", "mal", "malaki\xE1s"],
          ["mt", "mat", "m\xE1t\xE9"],
          ...
          ["ef", "efez", "ef\xE9zus"],
          ["flp", "filip", "filippi"],
          ["kol", "kolosz", "kolossz\xE9"],
          ["1te", "1tesz", "1tesszalonika"],
          ["2te", "2tesz", "2tesszalonika"],
          ["1tim", "1timo", "1tim\xF3teusz"],
          ["2tim", "2timo", "2tim\xF3teusz"],
          ["tit", "titu", "titusz"],
          ["flm", "filem", "filemon"],
          ["h\xE9b", "heb", "h\xE9berek"],
          ["jk", "jak", "jakab"],
          ["1pt", "1pet", "1p\xE9ter"],
          ["2pt", "2pet", "2p\xE9ter"],
          ["1jn", "1jan", "1j\xE1nos"],
